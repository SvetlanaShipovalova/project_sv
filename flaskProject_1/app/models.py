...
class Role(db.Model):
    ...
    def insert_roles():
        roles = {
            'User': [Permission.PASSENGERS],
            'Moderator': [Permission.PASSENGERS, Permission.DRIVERS],
            'Administrator': [Permission.PASSENGERS, Permission.DRIVERS, Permission.ADMINS]
        }
        default_role = "User"
        for r in roles.keys():
...
class User(db.Model, UserMixin):
    ...
    def is_admin(self):
        return self.can(Permission.ADMINS)
